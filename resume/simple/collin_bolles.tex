...
\begin{multicols}{2}
    ...
    {\fontsize{30}{30}\selectfont Bolles}
...
\begin{itemize}
    ...
    \item Optimized for low latency camera frame throughput
    \item Populated Linux device trees for newly designed hardware
    \item Added features to NVIDIA Linux Kernel to expand camera platform capabilities
...
\begin{itemize}
    ...
    \item Developed software to detect vegetation levels from drone footage
...
% Master's Thesis
\rSubSubSection{Master's Thesis}\par
Augmented Reality for the Visualization of Robotics Control Algorithms \par
\vspace{-10pt}
\begin{itemize}
    \setlength\itemsep{0pt}
    \setlength{\parskip}{0pt}
    \item Developed Unity app for the Meta Quest to enable visualizing RViz2 messages
    \item Integrate with motion capture to overlay virtual context in the physical world
    \item Allowed user to view virtual influences acting on the system in real time
\end{itemize}
...
\begin{itemize}
    ...
    \item Developed drivers for communicating with Sendyne GFD, TI battery management chip, and STM32 peripherals
\end{itemize}
\vspace{-10pt}
